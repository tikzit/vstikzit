      ...
      <table className="style-table">
        ...
        <tr>
          ...
          <td>
            ...
            <ColorPicker
              disabled={!enabled}
              value={colorHex("tikzit draw")}
              onChange={c => setColor("tikzit draw", c)}
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <ColorPicker
              disabled={!enabled}
              value={colorHex("tikzit fill")}
              onChange={c => setColor("tikzit fill", c)}
            />
          </td>
        </tr>
        <tr>
            ...
            <tr>
              ...
              <td>
                ...
                >
                  ...
                  <option value="pointer" selected={data.arrowTail === "pointer"}>
                    &lt;
                  </option>
                  <option value="flat" selected={data.arrowTail === "flat"}>
                    |
                  </option>
                </select>
                &nbsp;-&nbsp;
                ...
                >
                  ...
                  <option value="pointer" selected={data.arrowHead === "pointer"}>
                    &gt;
                  </option>
                  <option value="flat" selected={data.arrowHead === "flat"}>
                    |
                  </option>
                </select>
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                >
                  <option
                    value="none"
                    selected={!data.hasKey("dashed") && !data.hasKey("dotted")}
                  ></option>
                  <option value="dashed" selected={data.hasKey("dashed")}>
                    dashed
                  </option>
                  <option value="dotted" selected={data.hasKey("dotted")}>
                    dotted
                  </option>
                </select>
              </td>
